...
public class WorkerService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        PacktClient client = new PacktClient();

        Pair<String, String> bookInfo = client.checkNewBook();
        if (bookInfo == null) {
            Log.i(TAG, "failed to get free book info");
            return;
        }
        ...
        Log.i(TAG, "book title:" + bookTitle + " url:" + claimUrl);
        ...
        if (autoClaim) {
            ...
            Log.i(TAG, "login result: " + loginOk);
            if (loginOk) {
                client.claimNewBook(claimUrl);
